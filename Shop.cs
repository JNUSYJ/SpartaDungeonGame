...
namespace SpartaDungeonGame
{
    public class Shop
    {
        ...
        public Shop()
        {
            product =
            [
                new ShopItem("수련자 갑옷", "수련에 도움을 주는 갑옷입니다.", 0, 5, 1000, false),
                new ShopItem("무쇠 갑옷", "수련에 도움을 주는 갑옷입니다.", 0, 9, 2500, false),
                new ShopItem("스파르타의 갑옷", "스파르타의 전사들이 사용했다는 전설의 갑옷입니다.", 0, 15, 3500, false),
                new ShopItem("낡은 검", "쉽게 볼 수 있는 낡은 검입니다.", 2, 0, 600, false),
                new ShopItem("청동 도끼", "어디선가 사용됐던 거 같은 도끼입니다.", 5, 0, 1500, false),
                new ShopItem("스파르타의 창", "스파르타의 전사들이 사용했다는 전설의 창입니다.", 7, 0, 2100, false),
                new ShopItem("영주의 검", "그 영주가 아니라 실명이 영주인 사람이 쓴 검입니다.", 10, 0, 3000, false)
            ];
        }
