...
namespace SpartaDungeonGame
{
    public class Shop
    {
        ...
        public Shop()
        {
            product =
            [
                new ShopItem("수련자 갑옷", "방어구", "수련에 도움을 주는 갑옷입니다.", 0f, 5f, 1000, false),
                new ShopItem("무쇠 갑옷", "방어구", "수련에 도움을 주는 갑옷입니다.", 0f, 9f, 2500, false),
                new ShopItem("스파르타의 갑옷", "방어구", "스파르타의 전사들이 사용했다는 전설의 갑옷입니다.", 0f, 15f, 3500, false),
                new ShopItem("낡은 검", "무기", "쉽게 볼 수 있는 낡은 검입니다.", 2f, 0f, 600, false),
                new ShopItem("청동 도끼", "무기", "어디선가 사용됐던 거 같은 도끼입니다.", 5f, 0f, 1500, false),
                new ShopItem("스파르타의 창", "무기", "스파르타의 전사들이 사용했다는 전설의 창입니다.", 7f, 0f, 2100, false),
                new ShopItem("영주의 검", "무기", "그 영주가 아니라 실명이 영주인 사람이 쓴 검입니다.", 10f, 0f, 3000, false)
            ];
        }
